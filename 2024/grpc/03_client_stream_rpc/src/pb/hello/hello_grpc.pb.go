...
const (
	HelloService_Hello_FullMethodName = "/IDL.HelloService/Hello"
)
...
func (c *helloServiceClient) Hello(ctx context.Context, opts ...grpc.CallOption) (HelloService_HelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[0], HelloService_Hello_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (x *helloServiceHelloClient) CloseAndRecv() (*HelloResponse, error) {
...
func (x *helloServiceHelloServer) SendAndClose(m *HelloResponse) error {
